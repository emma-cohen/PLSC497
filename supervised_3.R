...
#Training set .7
##Baseline Accuracy:  0.6581967 
##SVM-Linear Accuracy: 0.7655738 
##SVM-Radial Accuracy: 0.6680328

###The baseline accuracy went slightly up, and the linear and radial accuracies went down.
